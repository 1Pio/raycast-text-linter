...
- Initial Text Linter implementation with paste cleanup, Markdown formatting rules, configurable settings, copy/paste actions, HTML/plain-text paste modes, save dialog support, and focused tests.
